            ...
            Usuario.findOne({ email: email })
                .then((user) => {
                    if (!user) { //Evalúa si el usuario no esta registrado en la bd
                        return done(null, false, { message: 'Email no registrado' }); //Si es verdad muestra mensaje
                    }
                    ...
                    bcrypt.compare(password, user.password, (err, isMatch) => {
                        ...
                        if (isMatch) { //Evalúa si las contraseñas coinciden
                            ...
                            return done(null, false, { message: 'Contraseña Incorrecta' }); //Si es falso muestra mensaje de error
                        }
                    })
                })
